...
typeahead({
    ...
    source: {
    remote: {
        url: "https://apifame.vercel.app/api/products?alias=%QUERY&select=name,urls,logo,cat,origin,bg", 
		wildcard: "%QUERY",
    requestOptions: {}
  },
...
for(i=0;i<cl.length;i++){
   ...
   // console.log("Nop")
    var Data = `<div style=" color:white; background-color:#1f282d; font-size:12px;" >` + new_link + `<p><br><span style="color:red;  font-size: 18px;"> The page you submitted doesn't belong to the person selected above</span>&nbsp; <span class="tooltip"> ❌ <span class="tooltiptext">Possibly scam. Report the page directly to the owner. </span> </p> </div>` ;
